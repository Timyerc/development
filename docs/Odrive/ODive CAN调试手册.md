...
**3、波特率设置为100kbit/s，连接设备**

**4、导入常用的CAN命令**

![image](image/OdriveCAN2.png)
...
发送：001h 01 FF FF 00 00      //转速01 + M0转速为1(2Byte) + M1转速为-1(2Byte)
```
...
发送：001h CB 00               //查询CB + 电机类型
返回：002h CB 00 00 1E 03 E8   //功能码 + 电机类型 + 判定时间(2Byte) + 电流阈值(2Byte)

发送：001h CB 01               //查询CB + 电机类型
返回：003h CB 00 00 1E 03 E8   //功能码 + 电机类型 + 判定时间(2Byte) + 电流阈值(2Byte)
```

```
设置电机过流的判定时间和阈值

发送：001h CA 00 00 1E 03 E8   //设置CA + 电机类型M0 + 设置时间(2Byte) + 设置电流(2Byte)
返回：002h CA 00 00 1E 03 E8   //功能码 + 电机类型 + 判定时间(2Byte) + 电流阈值(2Byte)

发送：001h CA 01 00 1E 03 E8   //设置CA + 电机类型M1 + 设置时间(2Byte) + 设置电流(2Byte)
返回：003h CA 00 00 1E 03 E8   //功能码 + 电机类型 + 判定时间(2Byte) + 电流阈值(2Byte)
```
